...
DATA_DIR = os.path.join(BASE_DIR, "Oulu interpolated")
...
WEIGHTS_PATH = os.path.join(AE_FOLDER, f"hc_weights_FULL_{shape_str}.pth")
PLOT_PATH = os.path.join(AE_FOLDER, f"loss_plot_FULL_{shape_str}.png")
SUMMARY_PATH = os.path.join(AE_FOLDER, f"training_summary_FULL_{shape_str}.txt")
...
def train():
    ...
    for epoch in range(EPOCHS):
        ...
        if epochs_no_improve >= PATIENCE:
            remaining = total_steps - master_pbar.n
